						...
						<td id="main_text">
							...
							<article>
								<header id="header1">
									<div>
										<div id="header3">
											<p><font id="main_text1">
														And we are his witnesses of these things; and so is also<br>
...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->									
								...
								<div id="slider">
									...
									<div id="image">									
										...
										<img id="Img5" src="../Image/IMG_005.jpg" />
										<img id="Img4" src="../Image/IMG_004.jpg" />
									...
									<div id="Snav">
										...
										<div id="SnavMiddle"><!-- the left and right button -->
											<img id="Sleft" src="../Image/left.png" onclick="prev()"/>
											<img id="Sright" src="../Image/right.png" onclick="next()"/>										
