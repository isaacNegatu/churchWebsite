			...
			<div id = "nav_wrap">
				<ul class = "nav_menue">
					...
					<li><a href="#">ABOUT US</a>
						<ul>
							<li><a href="Welcome.php">PASTOR'S MESSAGE</a></li>
							<li><a href="Faith_Statement.php">STATEMENT OF FAITH</a></li>
						</ul>
					</li>
					<li><a href="#">CHURCH SERVICE</a>
						<ul>
							<li><a href="Devotional.php">DEVOTION</a></li>
							<li><a href="Salvation.php">SALVATION</a></li>
							<li><a href="Bible_study_groups.php">BIBLE STUDY GROUPS</a></li>
							<li><a href="Prayer_request_form.php">PRAYER REQUEST</a></li>
							<li><a href="Media.php">SERMON</a></li>
						</ul>
					</li>
					<li><a href="#">MINISTRIES</a>
						<ul>
							<li><a href="page_in_progress.php">OUTREACH</a></li>
							<li><a href="../Choir/Choir_Index.php">CHOIR</a></li>
							<li><a href="page_in_progress.php">CHILDREN</a></li>
